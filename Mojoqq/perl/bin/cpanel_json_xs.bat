...
=item yaml - YAML (requires the YAML module)

=item yaml-xs - YAML (requires the YAML::XS module)

=item yaml-syck - YAML (requires the YAML::Syck module)
...
=item yaml-xs - YAML::XS

=item yaml-syck - YAML::Syck
